...
vector<string> GetFilesPath(int typeData, int simQ2range){
    ...
    if (typeData == 0 && simQ2range == 0){
    	result.push_back("/lustre24/expphy/volatile/clas12/valerii/incl-sim-pass-1-final/SimIter3_1.datAna.root"); 
        result.push_back("/lustre24/expphy/volatile/clas12/valerii/incl-sim-pass-1-final/SimIter3_2.datAna.root"); 
        result.push_back("/lustre24/expphy/volatile/clas12/valerii/incl-sim-pass-1-final/SimIter3_3.datAna.root"); 
        result.push_back("/lustre24/expphy/volatile/clas12/valerii/incl-sim-pass-1-final/SimIter3_4.datAna.root"); 
        result.push_back("/lustre24/expphy/volatile/clas12/valerii/incl-sim-pass-1-final/SimIter3_5.datAna.root"); 
        result.push_back("/lustre24/expphy/volatile/clas12/valerii/incl-sim-pass-1-final/SimIter3_6.datAna.root"); 
        result.push_back("/lustre24/expphy/volatile/clas12/valerii/incl-sim-pass-1-final/SimIter3_7.datAna.root"); 
        result.push_back("/lustre24/expphy/volatile/clas12/valerii/incl-sim-pass-1-final/SimIter3_8.datAna.root"); 
